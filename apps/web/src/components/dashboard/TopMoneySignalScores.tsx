  ...
  return (
    <div className="rounded border border-[#424754]/50 bg-[#181c23] p-4 transition-all hover:border-[#adc6ff]/50 hover:bg-[#1c2027]">
      <div className="mb-4 flex items-start justify-between">
        ...
        <div className="rounded border border-[#4edea3]/30 bg-[#4edea3]/10 px-3 py-1 font-mono text-[13px] text-[#4edea3]">
          {card.score}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex items-end justify-between">
          ...
          <p className="font-mono text-[12px] text-[#4edea3]">{card.change}</p>
        </div>
      </div>
    </div>
  );
